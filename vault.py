...
def print_accounts(account_list):
    ...
    for i in range(len(account_list)):
        table.add_row(account_list[i]["website_name"], account_list[i]["username"], account_list[i]["password"])
...
def handle_delete_account(account_list, password):
    ...
    save_account_list(account_list, password)
    return account_list
...
def handle_delete_all_accounts(account_list, password):
    old_account_list = account_list.copy()
    ...
    if len(account_list) == 0:
        console.print("All accounts have been successfully deleted from vault!")
...
def main():
    ...
    while True:
        ...
        if option == "1":
            ...
            p_list = handle_delete_all_accounts(p_list, master_password)
        else:
